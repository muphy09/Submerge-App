...
CREATE TABLE IF NOT EXISTS franchise_users (
    ...
    role TEXT NOT NULL CHECK(role IN ('master','owner','admin','bookkeeper','designer')),
    is_active INTEGER NOT NULL DEFAULT 1,
    dig_commission_rate REAL NOT NULL DEFAULT 0.0275,
    closeout_commission_rate REAL NOT NULL DEFAULT 0.0275,
    approval_margin_threshold_percent REAL NOT NULL DEFAULT 18,
    discount_allowance_threshold_percent REAL NOT NULL DEFAULT 18,
    always_require_approval INTEGER NOT NULL DEFAULT 0,
    created_at TEXT NOT NULL DEFAULT (datetime('now')),
    updated_at TEXT NOT NULL DEFAULT (datetime('now')),
